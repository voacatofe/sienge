...
export function SyncGroupsSection({
  ...
  if (!isConfigured) {
    return (
      <div className="bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 p-8 text-center mb-8">
        <svg
        ...
        <p className="text-gray-600">
          Configure suas credenciais da API Sienge primeiro para habilitar a
          sincronização.
        </p>
      </div>
    );
